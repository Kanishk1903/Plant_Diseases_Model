...
st.markdown(
    '<p class = "subtitle"> Upload a leaf image and get disease prediction with treatment recommendation.</p>',
    unsafe_allow_html = True
)
...
if uploader_file is not None:
    ...
    with col2:
        ...
        if confidence > 90:
            ...
            st.success(" Medium Confidence Prediction")
        else:
            st.success(" Low Confidence Prediction")
